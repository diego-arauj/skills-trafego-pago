...
def cmd_campaign(args):
    ...
    budget.explicitly_shared = False  # PMAX/Max Conversions exige orcamento dedicado, nao compartilhado
    ...
    if channel_type == "SEARCH":
        ...
        # Conta tem Brand Guidelines on por padrao, o que exigiria logo+business name
        # vinculados como CampaignAsset ja na criacao. Desligar para criar o casco via API;
        # nome de negocio e logo entram no asset group depois.
