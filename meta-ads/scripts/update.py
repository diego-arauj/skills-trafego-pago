...
def cmd_adset(args):
    ...
    if args.lifetime_budget:
        params['lifetime_budget'] = args.lifetime_budget
    if args.daily_min_spend_target:
        params['daily_min_spend_target'] = args.daily_min_spend_target
    if args.targeting:
    ...
    result = adset.api_get(fields=['id', 'name', 'status', 'daily_budget', 'lifetime_budget',
                                    'daily_min_spend_target', 'targeting', 'optimization_goal', 'bid_amount'])
...
def main():
    ...
    p.add_argument("--daily-budget", help="Orcamento diario em centavos")
    p.add_argument("--lifetime-budget", help="Orcamento vitalicio em centavos")
    p.add_argument("--daily-min-spend-target", help="Piso diario de gasto do ad set em centavos (CBO)")
